// Export case study information with detailed content
export const caseStudyInfo = [
  {
    ...
    content: `
      <h2>Digital Manufacturing Transformation</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>Financial Services Cloud Migration</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>Custom ERP Solution for Retail Chain</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>5G Equipment Vendor Swap Platform for Telecom Provider</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>Agentic AI Solution for Decentralized Task Marketplace</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>Hybrid Offshore SCADA: Siemens WinCC to Cloud-Native Transformation</h2>
  ...
  },
  {
    ...
    readMore: "Read Case Study",
    content: `
      <h2>Decentralized Talent Marketplace: Revolutionizing Tech & Creative Work with Blockchain</h2>
