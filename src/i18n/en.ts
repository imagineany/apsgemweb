...
export const enTranslations = {
  ...
  caseStudies: {
    ...
    items: [
      ...
      },
      {
        ...
        industry: "Finance",
        description: "Securely migrated critical systems to the cloud, improving performance and reducing infrastructure costs by 40%.",
        readMore: "Read Case Study"
      },
      {
  ...
  contact: {
    ...
    message: "Message",
    submit: "Send Message",
    address: "Technologiepark 10, Berlin, Germany",
