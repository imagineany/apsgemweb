...
export const deTranslations = {
  ...
  caseStudies: {
    ...
    items: [
      {
        title: "Digitale Transformation für einen Fertigungsführer",
        industry: "Fertigung",
        description: "Implementierung einer integrierten digitalen Plattform, die Betriebsabläufe optimierte und Kosten um 35% reduzierte.",
        readMore: "Fallstudie lesen"
      },
      {
        title: "Cloud-Migration für Finanzdienstleistungen",
        industry: "Finanzen",
        description: "Sichere Migration kritischer Systeme in die Cloud, Verbesserung der Leistung und Reduzierung der Infrastrukturkosten um 40%.",
        readMore: "Fallstudie lesen"
      },
      {
  ...
  contact: {
    ...
    address: "Technologiepark 10, Berlin, Deutschland",
